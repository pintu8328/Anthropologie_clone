        ...
        <div className={style.main}>
          ...
          <div style={{ border: "1px solid" }}>
            <div className={style.box5}>
              ...
              />
              <span className={style.card}>Credit Card</span>
              <br />
              <img
                ...
                >
                  <div className="card card-body">
                    ...
                    <input
                      ...
                      value={formData1}
                      onChange={(e) =>
                        formData1.length < 16 && setformData1(e.target.value)
                      }
                    />{" "}
                    <br />
                    <div
                    ...
                    >
                      ...
                      <div>
                        <span className={style.box1}>Year*</span>
                        <br />
                        <select
                          name=""
                          id="country"
                      ...
                      <div>
                        <span className={style.box1}>CVV*</span>
                        <br />
                        <input
                          required
                          className={style.box3}
                          style={{ width: "27vh", borderRadius: "0px" }}
                          type="number"
                          placeholder="***"
                          onChange={(e) =>
                            formData.length < 3 && setformData(e.target.value)
                          }
                          value={formData}
                        />
                      </div>
                  ...
                  <div className={style.box4}>
                    ...
                    <p>{data1.address2}</p>
                    <p>
                      {data1.city} / {data1.province} / {data1.postcode}
                    </p>
                    <p>{data1.country}</p>
                    <p>{data1.phone}</p>
                  </div>
