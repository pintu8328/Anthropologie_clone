    ...
    {/* {console.log(token)} */}
      ...
      >
        <div className="carousel-inner" style={{ height: "40px" }}>
          ...
          >
            <div className="d-flex  justify-content-center" style={{background:"#c44c4a"}}>
              <p className={`${styles.para} ${styles.small}`}>
                ends tonight
              </p>
              <p className={styles.para}>UP TO 30% OFF SUMMER ENTERTAINING ESSENTIALS </p>
              <a className={styles.link} href="">
                shop
              </a>
              <a className={styles.link} href="" style={{marginLeft:"10px"}}>
                detail
              </a>
            </div>
          </div>
          <div style={{ background: "#386f41" }} className="carousel-item">
            <div className="d-flex  justify-content-center">
              <p className={`${styles.para} ${styles.small}`}>new from the beloved Brazilian brand </p>
              <p className={styles.para}>Designer Spotlight: FARM RIO </p>
              <a className={styles.link} href="/">
